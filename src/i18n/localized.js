...
const services = {
  ...
  'aparato-digestivo': {
    ...
    'de-DE': ['Verdauungssystem', 'Spezialisierte Gastroenterologie, fortgeschrittene Endoskopie und Verdauungsultraschall.'],
    'fr-FR': ['Appareil digestif', 'Gastroentérologie spécialisée, endoscopie avancée et échographie digestive.'],
    'zh-CN': ['消化系统', '专业胃肠科、先进内镜检查和消化系统超声检查。'],
    ar: ['الجهاز الهضمي', 'تخصص في أمراض الجهاز الهضمي، المناظير المتقدمة والموجات فوق الصوتية الهضمية.'],
  },
  psicologia: {
...
const professionalDetails = {
  ...
  'en-GB': {
    ...
    'jordi-asensio-porti': { role: 'Gastroenterology · Digestive system', bio: 'Graduated in Medicine from the Autonomous University of Barcelona and specialised in Digestive System (Gastroenterology and Hepatology) through MIR at the prestigious Hospital de la Santa Creu i Sant Pau in Barcelona, Dr. Jordi Asensio Porti offers first-class medical care grounded in rigorous training and extensive clinical experience. He holds a qualification in advanced digestive ultrasound recognised by the Spanish Association of Digestive Ultrasound and trained practically at the Hospital Universitario 12 de Octubre in Madrid, where he also specialised in hepatic elastography / fibroscan. He also complements his high-level qualifications with a university master’s degree in Digestive Pathology from the Universitat Oberta de Catalunya. Today, Dr. Asensio develops his private consultation and digestive endoscopy activity at Centre Sanitari Villaquet in Calafell, bringing highly specialised, close and trustworthy medical care to patients throughout the Baix Penedès region. He combines this private activity with his work in a university hospital in the Barcelona area, where he is part of the inflammatory bowel disease unit (ulcerative colitis and Crohn’s disease), assists in the acute digestive pathology inpatient ward and works in the Digestive Endoscopy Unit, while also actively training residents and future gastroenterologists. His solid hospital background, together with his personalised dedication in Calafell, allows him to offer precise diagnosis and advanced treatment to ensure the wellbeing and digestive health of his patients.' },
