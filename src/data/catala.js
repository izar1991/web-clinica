...
export const professionalsCa = /** @type {Record<string, { role: string; bio: string }>} */ ({
  ...
  'jose-andres-collantes-cosquillo': {
    role: 'Traumatologia',
    bio: 'Metge cirurgià amb el títol homologat a Espanya i resident de Cirurgia Ortopèdica i Traumatologia a l’Hospital Universitari Joan XXIII de Tarragona. Té formació en fractures, patologia de genoll, espatlla, mà, canell i maluc, i és membre de la SECOT i la SEROD.',
  },
});
...
export const contingutEspecialitatsCa = {
  ...
  traumatologia: { title: 'Traumatologia a Calafell', subtitle: 'Valoració i atenció especialitzada de lesions i problemes de l’aparell locomotor.', intro: 'La traumatologia aborda les lesions i les malalties de l’aparell locomotor, des de fractures i lesions articulars fins a problemes de genoll, espatlla, mà, canell i maluc. Al Centre Sanitari Villaquet t’oferim una valoració professional i un seguiment personalitzat.', highlights: [['Valoració especialitzada', 'Avaluació de lesions i problemes musculoesquelètics amb un enfocament precís i personalitzat.'], ['Extremitats i articulacions', 'Formació específica en patologia de genoll, espatlla, mà, canell i maluc.'], ['Atenció integral', 'Coordinació amb proves diagnòstiques i altres professionals quan sigui necessari.']], bullets: ['Valoració de lesions i problemes de l’aparell locomotor', 'Atenció de fractures i lesions articulars', 'Patologia de genoll, espatlla, mà, canell i maluc', 'Seguiment personalitzat del procés assistencial'], cta: 'Reservar traumatologia' },
